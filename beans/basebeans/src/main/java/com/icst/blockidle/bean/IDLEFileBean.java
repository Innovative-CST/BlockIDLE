 ...
 *
 * This class implements {@link Serializable} to allow instances to be serialized and passed
...
public class IDLEFileBean implements Serializable {
	 ...
	 *
	 * This method can be overridden by subclasses to provide specific file types.
	 *
