 ...
 *
 * The {@code DatatypeBean} class encapsulates metadata for a class or type used in the code
 ...
 *
 * This class is designed to support type checking, hierarchical relationship inspection,
 * cloning, and formatted string representation of the type's lineage.
 *
 * Key Features:
 *
 * <ul>
 *   <li>Stores both the simple class name and the fully qualified class name.</li>
 *   <li>Supports a recursive structure to represent super types.</li>
 *   <li>Provides a method to determine whether a type is a supertype or equal to another type.</li>
 *   <li>Implements deep cloning via the {@link CloneableBean} interface.</li>
 *   <li>Overrides {@code toString()} to return a formatted inheritance tree.</li>
 * </ul>
 *
 * Example usage:
 *
...
public class DatatypeBean implements CloneableBean<DatatypeBean>, Serializable {
	...
	/**
	 * Adds a new super type to the list of this data type’s super types.
	 *
	 ...
	 *
	 * Uses {@link BeanArrayCloneUtils#clone(java.util.ArrayList)} to clone the super types list.
	 *
	 ...
	 * hierarchy.
	 *
	 * This method provides a hierarchical view of the current data type and its super types,
	 ...
	 *
	 * The output is wrapped in Markdown-style code block formatting to improve rendering in
