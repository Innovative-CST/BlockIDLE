...
public final class TermuxConstants {
	...
	/** Termux app name */
	public static final String TERMUX_APP_NAME = "Block IDLE"; // Default: "Termux"
	/** Termux package name */
	public static final String TERMUX_PACKAGE_NAME = "com.icst.blockidle"; // Default: "com.termux"
	/** Termux GitHub repo name */
	public static final String TERMUX_GITHUB_REPO_NAME = "BlockIDLE"; // Default: "termux-app"
