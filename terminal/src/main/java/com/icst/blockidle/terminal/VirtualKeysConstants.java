...
public class VirtualKeysConstants {
	...
	public static final VirtualKeyDisplayMap CONTROL_CHARS_ALIASES = new VirtualKeyDisplayMap() {
		{
			put("ESCAPE", "ESC");
			put("CONTROL", "CTRL");
			put("SHFT", "SHIFT");
	...
	public static class EXTRA_KEY_DISPLAY_MAPS {
		...
		public static final VirtualKeyDisplayMap CLASSIC_ARROWS_DISPLAY = new VirtualKeyDisplayMap() {
			{
		...
		public static final VirtualKeyDisplayMap WELL_KNOWN_CHARACTERS_DISPLAY = new VirtualKeyDisplayMap() {
			{
		...
		public static final VirtualKeyDisplayMap LESS_KNOWN_CHARACTERS_DISPLAY = new VirtualKeyDisplayMap() {
			{
		...
		public static final VirtualKeyDisplayMap ARROW_TRIANGLE_VARIATION_DISPLAY = new VirtualKeyDisplayMap() {
			{
		...
		public static final VirtualKeyDisplayMap NOT_KNOWN_ISO_CHARACTERS = new VirtualKeyDisplayMap() {
			{
		...
		public static final VirtualKeyDisplayMap NICER_LOOKING_DISPLAY = new VirtualKeyDisplayMap() {
			{
		...
		/** Full Iso */
		public static final VirtualKeyDisplayMap FULL_ISO_CHAR_DISPLAY = new VirtualKeyDisplayMap() {
			{
		...
		/** Only arrows */
		public static final VirtualKeyDisplayMap ARROWS_ONLY_CHAR_DISPLAY = new VirtualKeyDisplayMap() {
			{
				putAll(CLASSIC_ARROWS_DISPLAY);
		...
		public static final VirtualKeyDisplayMap LOTS_OF_ARROWS_CHAR_DISPLAY = new VirtualKeyDisplayMap() {
			{
				putAll(CLASSIC_ARROWS_DISPLAY);
				putAll(WELL_KNOWN_CHARACTERS_DISPLAY);
				putAll(LESS_KNOWN_CHARACTERS_DISPLAY); // NEW
		...
		public static final VirtualKeyDisplayMap DEFAULT_CHAR_DISPLAY = new VirtualKeyDisplayMap() {
			{
				putAll(CLASSIC_ARROWS_DISPLAY);
				putAll(WELL_KNOWN_CHARACTERS_DISPLAY);
				putAll(NICER_LOOKING_DISPLAY);
