...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView implements TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView
{
    ...
    public AppCompatAutoCompleteTextView(@NonNull final Context context) {
        this(context, null);
    }
    
    public AppCompatAutoCompleteTextView(@NonNull final Context context, @Nullable final AttributeSet attrs) {
        this(context, attrs, R.attr.autoCompleteTextViewStyle);
    }
    
    public AppCompatAutoCompleteTextView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
        super(TintContextWrapper.wrap(context), attrs, defStyleAttr);
        ThemeUtils.checkAppCompatTheme((View)this, this.getContext());
        final TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.getContext(), attrs, AppCompatAutoCompleteTextView.TINT_ATTRS, defStyleAttr, 0);
        if (a.hasValue(0)) {
