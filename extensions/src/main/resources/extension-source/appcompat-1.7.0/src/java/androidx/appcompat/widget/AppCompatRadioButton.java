...
public class AppCompatRadioButton extends RadioButton implements TintableCompoundButton, TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView
{
    ...
    public AppCompatRadioButton(final Context context, @Nullable final AttributeSet attrs) {
        this(context, attrs, R.attr.radioButtonStyle);
    }
    
    public AppCompatRadioButton(final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
