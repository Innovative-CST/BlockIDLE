...
public class AppCompatToggleButton extends ToggleButton implements TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView
{
    ...
    public AppCompatToggleButton(@NonNull final Context context) {
        this(context, null);
    }
    
    public AppCompatToggleButton(@NonNull final Context context, @Nullable final AttributeSet attrs) {
        this(context, attrs, 16842827);
    }
    
    public AppCompatToggleButton(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
