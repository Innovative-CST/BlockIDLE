...
public class AppCompatImageView extends ImageView implements TintableBackgroundView, TintableImageSourceView
{
    ...
    public AppCompatImageView(@NonNull final Context context, @Nullable final AttributeSet attrs) {
        this(context, attrs, 0);
    }
    
    public AppCompatImageView(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
        ...
        (this.mImageHelper = new AppCompatImageHelper(this)).loadFromAttributes(attrs, defStyleAttr);
    }
