...
public final class PdfRendererPreV implements AutoCloseable
{
    ...
    public PdfRendererPreV(@NonNull final ParcelFileDescriptor fileDescriptor) throws IOException {
        throw new RuntimeException("Stub!");
    }
    
    public PdfRendererPreV(@NonNull final ParcelFileDescriptor fileDescriptor, @NonNull final LoadParams params) throws IOException {
        throw new RuntimeException("Stub!");
    }
    ...
    public final class Page implements AutoCloseable
    {
        ...
        @NonNull
        public FormWidgetInfo getFormWidgetInfoAtIndex(final int annotationIndex) {
            throw new RuntimeException("Stub!");
        }
