...
public class GLES31Ext
{
    ...
    public static native void glDebugMessageControlKHR(final int p0, final int p1, final int p2, final int p3, final int[] p4, final int p5, final boolean p6);
    
    public static native void glDebugMessageControlKHR(final int p0, final int p1, final int p2, final int p3, final IntBuffer p4, final boolean p5);
    
    public static native void glDebugMessageInsertKHR(final int p0, final int p1, final int p2, final int p3, final String p4);
    
    public static native void glDebugMessageCallbackKHR(final DebugProcKHR p0);
    
    public static native int glGetDebugMessageLogKHR(final int p0, final int p1, final int[] p2, final int p3, final int[] p4, final int p5, final int[] p6, final int p7, final int[] p8, final int p9, final int[] p10, final int p11, final byte[] p12, final int p13);
    
    public static native int glGetDebugMessageLogKHR(final int p0, final IntBuffer p1, final IntBuffer p2, final IntBuffer p3, final IntBuffer p4, final IntBuffer p5, final ByteBuffer p6);
    
    public static native String[] glGetDebugMessageLogKHR(final int p0, final int[] p1, final int p2, final int[] p3, final int p4, final int[] p5, final int p6, final int[] p7, final int p8);
    
    public static native String[] glGetDebugMessageLogKHR(final int p0, final IntBuffer p1, final IntBuffer p2, final IntBuffer p3, final IntBuffer p4);
    
    public static native void glPushDebugGroupKHR(final int p0, final int p1, final int p2, final String p3);
    
    public static native void glPopDebugGroupKHR();
    
    public static native void glObjectLabelKHR(final int p0, final int p1, final int p2, final String p3);
    
    public static native String glGetObjectLabelKHR(final int p0, final int p1);
    
    public static native void glObjectPtrLabelKHR(final long p0, final String p1);
    
    public static native String glGetObjectPtrLabelKHR(final long p0);
    
    public static native DebugProcKHR glGetDebugMessageCallbackKHR();
    
    public static native void glMinSampleShadingOES(final float p0);
    
    public static native void glTexStorage3DMultisampleOES(final int p0, final int p1, final int p2, final int p3, final int p4, final int p5, final boolean p6);
    
    public static native void glCopyImageSubDataEXT(final int p0, final int p1, final int p2, final int p3, final int p4, final int p5, final int p6, final int p7, final int p8, final int p9, final int p10, final int p11, final int p12, final int p13, final int p14);
    
    public static native void glEnableiEXT(final int p0, final int p1);
    
    public static native void glDisableiEXT(final int p0, final int p1);
    
    public static native void glBlendEquationiEXT(final int p0, final int p1);
    
    public static native void glBlendEquationSeparateiEXT(final int p0, final int p1, final int p2);
    
    public static native void glBlendFunciEXT(final int p0, final int p1, final int p2);
    
    public static native void glBlendFuncSeparateiEXT(final int p0, final int p1, final int p2, final int p3, final int p4);
    
    public static native void glColorMaskiEXT(final int p0, final boolean p1, final boolean p2, final boolean p3, final boolean p4);
    
    public static native boolean glIsEnablediEXT(final int p0, final int p1);
    
    public static native void glFramebufferTextureEXT(final int p0, final int p1, final int p2, final int p3);
    
    public static native void glPrimitiveBoundingBoxEXT(final float p0, final float p1, final float p2, final float p3, final float p4, final float p5, final float p6, final float p7);
    
    public static native void glPatchParameteriEXT(final int p0, final int p1);
    
    public static native void glTexParameterIivEXT(final int p0, final int p1, final int[] p2, final int p3);
    
    public static native void glTexParameterIivEXT(final int p0, final int p1, final IntBuffer p2);
    
    public static native void glTexParameterIuivEXT(final int p0, final int p1, final int[] p2, final int p3);
    
    public static native void glTexParameterIuivEXT(final int p0, final int p1, final IntBuffer p2);
    
    public static native void glGetTexParameterIivEXT(final int p0, final int p1, final int[] p2, final int p3);
    
    public static native void glGetTexParameterIivEXT(final int p0, final int p1, final IntBuffer p2);
    
    public static native void glGetTexParameterIuivEXT(final int p0, final int p1, final int[] p2, final int p3);
    
    public static native void glGetTexParameterIuivEXT(final int p0, final int p1, final IntBuffer p2);
    
    public static native void glSamplerParameterIivEXT(final int p0, final int p1, final int[] p2, final int p3);
    
    public static native void glSamplerParameterIivEXT(final int p0, final int p1, final IntBuffer p2);
    
    public static native void glSamplerParameterIuivEXT(final int p0, final int p1, final int[] p2, final int p3);
    
    public static native void glSamplerParameterIuivEXT(final int p0, final int p1, final IntBuffer p2);
    
    public static native void glGetSamplerParameterIivEXT(final int p0, final int p1, final int[] p2, final int p3);
    
    public static native void glGetSamplerParameterIivEXT(final int p0, final int p1, final IntBuffer p2);
    
    public static native void glGetSamplerParameterIuivEXT(final int p0, final int p1, final int[] p2, final int p3);
    
    public static native void glGetSamplerParameterIuivEXT(final int p0, final int p1, final IntBuffer p2);
    
    public static native void glTexBufferEXT(final int p0, final int p1, final int p2);
    
    public static native void glTexBufferRangeEXT(final int p0, final int p1, final int p2, final int p3, final int p4);
