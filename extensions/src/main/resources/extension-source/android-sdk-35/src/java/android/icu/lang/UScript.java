...
public final class UScript
{
    ...
    public static int[] getCode(final Locale locale) {
        throw new RuntimeException("Stub!");
    }
    
    public static int[] getCode(final ULocale locale) {
        throw new RuntimeException("Stub!");
    }
    
    public static int[] getCode(final String nameOrAbbrOrLocale) {
        throw new RuntimeException("Stub!");
    }
    
    public static int getCodeFromName(final String nameOrAbbr) {
        throw new RuntimeException("Stub!");
    }
    
    public static int getScript(final int codepoint) {
        throw new RuntimeException("Stub!");
    }
    
    public static boolean hasScript(final int c, final int sc) {
        throw new RuntimeException("Stub!");
    }
    
    public static int getScriptExtensions(final int c, final BitSet set) {
        throw new RuntimeException("Stub!");
    }
    
    public static String getName(final int scriptCode) {
        throw new RuntimeException("Stub!");
    }
    
    public static String getShortName(final int scriptCode) {
        throw new RuntimeException("Stub!");
    }
    
    public static String getSampleString(final int script) {
        throw new RuntimeException("Stub!");
    }
    
    public static ScriptUsage getUsage(final int script) {
        throw new RuntimeException("Stub!");
    }
    
    public static boolean isRightToLeft(final int script) {
        throw new RuntimeException("Stub!");
    }
    
    public static boolean breaksBetweenLetters(final int script) {
        throw new RuntimeException("Stub!");
    }
    
    public static boolean isCased(final int script) {
        throw new RuntimeException("Stub!");
    }
