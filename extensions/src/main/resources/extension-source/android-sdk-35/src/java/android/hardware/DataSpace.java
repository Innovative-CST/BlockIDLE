...
public final class DataSpace
{
    ...
    public static int pack(final int standard, final int transfer, final int range) {
        throw new RuntimeException("Stub!");
    }
    
    public static int getStandard(final int dataSpace) {
        throw new RuntimeException("Stub!");
    }
    
    public static int getTransfer(final int dataSpace) {
        throw new RuntimeException("Stub!");
    }
    
    public static int getRange(final int dataSpace) {
        throw new RuntimeException("Stub!");
    }
}
