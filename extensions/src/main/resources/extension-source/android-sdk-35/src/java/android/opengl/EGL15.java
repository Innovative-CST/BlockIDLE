...
public final class EGL15
{
    ...
    public static native EGLSync eglCreateSync(final EGLDisplay p0, final int p1, final long[] p2, final int p3);
    
    public static native boolean eglGetSyncAttrib(final EGLDisplay p0, final EGLSync p1, final int p2, final long[] p3, final int p4);
    
    public static native boolean eglDestroySync(final EGLDisplay p0, final EGLSync p1);
    
    public static native int eglClientWaitSync(final EGLDisplay p0, final EGLSync p1, final int p2, final long p3);
    
    public static native EGLDisplay eglGetPlatformDisplay(final int p0, final long p1, final long[] p2, final int p3);
    
    public static native EGLSurface eglCreatePlatformWindowSurface(final EGLDisplay p0, final EGLConfig p1, final Buffer p2, final long[] p3, final int p4);
    
    public static native EGLSurface eglCreatePlatformPixmapSurface(final EGLDisplay p0, final EGLConfig p1, final Buffer p2, final long[] p3, final int p4);
    
    public static native boolean eglWaitSync(final EGLDisplay p0, final EGLSync p1, final int p2);
    
    public static native EGLImage eglCreateImage(final EGLDisplay p0, final EGLContext p1, final int p2, final long p3, final long[] p4, final int p5);
    
    public static native boolean eglDestroyImage(final EGLDisplay p0, final EGLImage p1);
