/*
 * This file is part of the Termux app: https://github.com/termux/termux-app
 *
 * Copyright (C) 2018-2023 The Termux Project
 *
...
package com.icst.blockidle.provider;
...
public class BlockIDLEDocumentsProvider extends DocumentsProvider {
	...
	*/
	...
	private static final File BASE_DIR = new File("/data/data/com.icst.blockidle/files/home");
	...
	public Cursor querySearchDocuments(String rootId, String query, String[] projection) throws FileNotFoundException {
		...
		while (!pending.isEmpty() && result.getCount() < MAX_SEARCH_RESULTS) {
			...
			try {
				isInsideHome = file.getCanonicalPath().startsWith("/data/data/com.icst.blockidle/files/home");
			} catch (IOException e) {
				isInsideHome = true;
			}
			if (isInsideHome) {
